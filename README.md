...
我们使用 hey 工具进行压力测试（-n 2000 个总请求，-c 100 个并发用户），在缓存全部命中的理想情况下，取得了以下成果：
...
**P99 延迟从 2.6 秒到 602 毫秒的巨大优化**，标志着我们成功消除了数据库在高并发下的主要性能瓶颈，极大地提升了系统的**健壮性和可靠性**，确保了绝大多数用户请求能在高压下依然得到快速响应。
